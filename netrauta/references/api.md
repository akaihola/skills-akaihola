# Netrauta – Loop54 Search API

The Netrauta webshop uses **Loop54** as its search backend.

## Search endpoint

```
POST https://netrauta-fi-prod.54proxy.com/search
...
| `product_url`  | Relative product URL (prefix with `https://www.netrauta.fi`) |
...
- Loop54 is a product discovery platform; the proxy URL is specific to Netrauta
