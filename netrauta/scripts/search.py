...
# dependencies = ["httpx"]
# ///
"""Search products on netrauta.fi via the Loop54 search API.
...
API_URL = "https://netrauta-fi-prod.54proxy.com/search"
SITE_BASE = "https://www.netrauta.fi"
DEFAULT_LIMIT = 10
...
def search_products(
    ...
    *,
    ...
    """Search Netrauta products via the Loop54 search API."""
    payload = {
        "query": query,
        "resultsOptions": {
            "skip": skip,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Search products on netrauta.fi",
    )
